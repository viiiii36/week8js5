 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting =new Greeting('Vi','CA')
myGreeting.hello()
/*-------------------------------------------------------*/
// Question 3: myBook
console.log(`--------------------------
...
let yourBook=new Book('How to fuck up','Vi')
...
class Fruit{
  constructor (name,color,taste){
    ...
    this.taste=taste;}
    fruitDesc(){
      console.log(`A ${this.fruit} is ${this.color} and has a ${this.taste} taste`)
    }
  }
...
class List{
  ...
  displayMovies(){
    ...
    {
      console.log(`${this.tools[i].title} by ${this.tools[i].director}\n`);
    }
  }
}
